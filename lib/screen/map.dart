    ...
    return Scaffold(
      ...
      body: GoogleMap(
        onMapCreated: (controller) {
          ...
          _updateCamera(); // Ensure the camera updates to fit all points once the map is created
        },
        initialCameraPosition: CameraPosition(
          target: _userLocation ??
              (_collectionPoints.isNotEmpty
                  ...
                  : LatLng(
                      0, 0)), // Default to (0, 0) if no locations are available
          zoom: _zoomLevel,
        ),
      ...
      bottomSheet: Container(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text('Distance: ${_distanceToDestination.toStringAsFixed(2)} km',
                style: const TextStyle(fontSize: 16)),
